...
const OperationalManagerLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const result = await login(email, password, USER_ROLES.OPERATIONAL_MANAGER);
      navigate(ROUTES.OPERATIONAL_MANAGER_DASHBOARD);
    } catch (error) {
        ...
        <div className="max-w-md w-full space-y-8">
          <div className="text-center">
            ...
            <p className="mt-2 text-center text-sm text-gray-600">
              Sign in to access the Operational Manager Dashboard
            </p>
          </div>
